...
const CCUnit ch[4]={{tim,1},{tim,2},{tim,3},{tim,4}};
//PD 12..15 af3
#define CHPIN(port,bitnum) ConfPin(port,bitnum,PinOptions::function,PinOptions::slow, PinOptions::F, 3);
CHPIN(D,12)
CHPIN(D,13)
CHPIN(D,14)
CHPIN(D,15)

ConfPin(D,10,PinOptions::output,PinOptions::slow, PinOptions::F, 0);
